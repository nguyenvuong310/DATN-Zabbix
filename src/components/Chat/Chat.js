...
function Chat() {
  ...
  return (
    <div className=" w-full h-[85%] flex items-center justify-center overflow-auto overflow-y-auto px-2 py-1 scroll sm:mb-10 max-sm:mb-2">
      <div className="w-[90%] max-sm:w-[85%] lg:w-4/5 xl:w-3/4 flex flex-col h-full items-start justify-start">
        {message?.map((msg, i) => (
          <span
            key={i}
            className={
